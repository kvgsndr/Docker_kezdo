    ...
    <Container>
      ...
      >
        ...
        <StyledMenuItem
          translate="no"
          onClick={() => {
            window.open("https://github.com/Liquizar/Docker_Beginner_Assignment");
          }}
        >
          <GitHub /> &nbsp; Github{" "}
          {stars && (
        ...
        <StyledMenuItem
          onClick={() => {
            window.open("https://github.com/Liquizar/Docker_Beginner_Assignment/issues/new");
          }}
        >
          <BugReportRounded /> &nbsp; Report Issue{" "}
          {Boolean(issuesCount || issuesCount === 0) && (
            <Tooltip title={`${issuesCount} open issues`}>
              <MenuLabel clr={issuesCount && issuesCount > 0 ? ColorPalette.Blue : "#3bb61c"}>
                <span style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/Liquizar"
            >
              Liquizar
            </a>
          </CreditsContainer>
